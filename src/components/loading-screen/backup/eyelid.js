    ...
    return (
        <div className={styles.container}>
            <div className={styles.loaderContainer}>
                <svg className={styles.spinner} stroke="#000" width="200" height="200" viewBox="0 0 206 206"
                    ...
                    <circle className={styles.path} fill="none" strokeWidth="6" strokeLinecap="round" cx="103" cy="103" r="100">
                    </circle>
                </svg>
                <svg id="scottie-loader" className={styles.loaderDog}
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 207.95 211.52">
                    <defs>
                        <radialGradient id="a" cx="100.23" cy="111.94" r="146.5"
                            gradientTransform="matrix(.68 0 0 .68 31.58 35.11)" gradientUnits="userSpaceOnUse">
...
// OTHER WAYS TO DO THE BLINK AND ENDBLINK FUNCTIONS
