...
import { Container, Dog, Eyelid, Loader, Path, Spinner } from "./loading.styles";
...
const Loading = () => {
    ...
    const [rightEarClass, setRightEarClass] = useState("");
    const rightEarRef = useRef(null);

    const twitchRightStart = () => {
        setTimeout(() => {
            setRightEarClass("earTwitch");
